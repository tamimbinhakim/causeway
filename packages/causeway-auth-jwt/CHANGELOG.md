# Changelog · `causeway-auth-jwt`

All notable changes to the `causeway-auth-jwt` Python package will be documented in
...
## [0.2.0](https://github.com/tamimbinhakim/causeway/compare/causeway-auth-jwt-v0.1.0...causeway-auth-jwt-v0.2.0) (2026-05-16)
