"""Dramatiq adapter for Quay's :class:`quay.contracts.TaskAdapter`.

Dramatiq has its own actor model — we adapt it to Quay's TaskRef + enqueue
...
from quay.tasks import TaskRef, TaskState, set_adapter


class DramatiqAdapter:
    """Routes Quay tasks through a Dramatiq Redis broker.
