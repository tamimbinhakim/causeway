...
A reproducible harness comparing Causeway vs FastAPI vs Litestar vs the underlying RPC layer (raw `dyadpy`) across:
...
cd benchmarks
uv sync
uv run python bench.py --target causeway
