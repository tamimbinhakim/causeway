...
> **Note.** The 0.1 `emit(name: str, payload: Any)` function has been removed. Events are now class-based — see [Events](../../app/events.md) for the new model.
...
- [Testing — `captured()` / `captured_webhooks()`](../../app/testing.md)
