...
The override uses the same scope machinery as production — there's no separate "test injection" path to learn. See [Testing](../app/testing.md).
...
- [Reference — `provide`](../reference/decorators/provide.md)
- [Reference — file conventions](../reference/file-conventions/scope-py.md)
