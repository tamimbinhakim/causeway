...
- **[Why Causeway](./why-causeway.md)** — the AML-software → FastAPI → dyadpy → Causeway story, the six principles, the positioning matrix, the explicit non-goals.
...
What Causeway promises about itself.
...
- **[Architecture](./internals/architecture.md)** — what happens when you type `causeway dev`.
