...
For entry-point auto-loaded plugins, the package's own `plugin(settings)` function calls `register()` for you — see [Plugin authoring](../../building/plugins/authoring.md).
