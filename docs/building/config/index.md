...
For request-scoped values that depend on settings (a DB pool, a Stripe client), build them once in a `_scope.py` startup and expose them via `@provide`. See [Scopes](../routing/scopes.md).
...
- [Plugins](../plugins/index.md) — installing adapters with config.
- [Reference — `Settings`](../../api-reference/classes/Settings.md)
- [Reference — `Manifest`](../../api-reference/classes/Manifest.md)
